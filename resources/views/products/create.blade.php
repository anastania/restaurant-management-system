                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex gap-2">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="sizes[]" value="Normal" id="sizeNormal" checked>
                                                <label class="form-check-label" for="sizeNormal">Normal</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="sizes[]" value="Large" id="sizeLarge">
                                    ...
                                    <div>
                                        ...
                                        <div class="d-flex gap-2">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="options[]" value="Extra fromage" id="optionCheese">
                                                <label class="form-check-label" for="optionCheese">Extra fromage</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="options[]" value="Épicé" id="optionSpicy">
